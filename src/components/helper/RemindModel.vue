...
export default {
  ...
  setup() {
    ...
    function closeModel() {
      statusData.remindModel.open = false;
      statusData.remindModel.title = '';
      statusData.remindModel.text = '';
    }
    return {
      statusData,
      closeModel,
...
<template>
  <div
    ...
    :class="{ active: statusData.remindModel.open === true }"
  >
    <!-- Modal-Overlay -->
    <div class="popModalCover" @click="statusData.remindModel.open = false" />

    <!-- Modal-Window -->
    <div class="popModal" :class="{ active: statusData.remindModel.open === true }">
      <button
        @click="statusData.remindModel.open = false"
        type="button"
